...
execute at @a[scores={TC_Target=1,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s add PlayerT
execute at @a[scores={TC_Target=1,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Targeting players.","color":"gray"}]

execute at @a[scores={TC_Target=2,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s add FriendlyT
execute at @a[scores={TC_Target=2,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Targeting friendlies.","color":"gray"}]

execute at @a[scores={TC_Target=3,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s add NeutralT
execute at @a[scores={TC_Target=3,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Targeting neutrals.","color":"gray"}]

execute at @a[scores={TC_Target=4,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s add HostileT
execute at @a[scores={TC_Target=4,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Targeting hostiles.","color":"gray"}]

execute at @a[scores={TC_Target=-1,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s remove PlayerT
execute at @a[scores={TC_Target=-1,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Not targeting players.","color":"gray"}]

execute at @a[scores={TC_Target=-2,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s remove FriendlyT
execute at @a[scores={TC_Target=-2,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Not targeting friendlies.","color":"gray"}]

execute at @a[scores={TC_Target=-3,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s remove NeutralT
execute at @a[scores={TC_Target=-3,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Not targeting neutrals.","color":"gray"}]

execute at @a[scores={TC_Target=-4,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tag @s remove HostileT
execute at @a[scores={TC_Target=-4,TC_UUID0=0,TC_UUID1=0,TC_UUID2=0,TC_UUID3=0}] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run tellraw @p [{"text":"[","color":"dark_green"},{"selector":"@s"},{"text":"]"},{"text":" Not targeting hostiles.","color":"gray"}]
