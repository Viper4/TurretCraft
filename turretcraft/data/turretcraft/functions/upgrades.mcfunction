...
#Data merging aesthetic pieces
	...
	execute at @s if entity @e[type=item,nbt={Item:{id:"minecraft:conduit",Count:1b,tag:{isComponent:1b}}},distance=..1,limit=1] run data modify entity @e[type=minecraft:wither_skeleton,tag=TurretHealth,distance=..1,limit=1,sort=nearest] CustomName set from entity @s CustomName
