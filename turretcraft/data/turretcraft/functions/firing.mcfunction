...
execute at @s[tag=Turret4C,scores={TC_TurretCon=0..1}] positioned ~ ~1.2 ~ run summon arrow ^ ^ ^0.1 {CustomName:'{"text":"Flamethrower"}',Tags:["Bullet","Flame","New"],PierceLevel:1,damage:0.2,SoundEvent:"minecraft:block.fire.ambient"}
execute at @s[tag=Turret4C,scores={TC_TurretCon=2}] at @s positioned ~ ~1.2 ~ run summon arrow ^ ^ ^0.1 {CustomName:'{"text":"Flamethrower"}',Tags:["Bullet","Flame","New"],PierceLevel:1,damage:0.3,SoundEvent:"minecraft:block.fire.ambient"}
