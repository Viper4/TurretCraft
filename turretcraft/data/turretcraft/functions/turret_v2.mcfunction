...
#Rotation of V2 and playing ambient sound
	execute at @e[type=minecraft:armor_stand,tag=Turret2H,tag=!Upgraded1] unless entity @e[type=!experience_orb,type=!item_frame,type=!painting,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,distance=..10,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ ~1.5 ~
	execute at @e[type=minecraft:armor_stand,tag=Turret2H,tag=Upgraded1] unless entity @e[type=!experience_orb,type=!item_frame,type=!painting,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,distance=..14,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ ~1.5 ~
	...
	#Detecting for unwanted entities in 10 block radius facing towards them, and adding the "Firing" tag
		execute at @e[type=minecraft:armor_stand,tag=Turret2H,tag=!Upgraded1] if entity @e[type=!minecraft:armor_stand,tag=!Allowed,distance=..10,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!Bullet,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ facing entity @e[type=!experience_orb,type=!painting,type=!item_frame,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,tag=!Door,distance=..11,sort=nearest,limit=1]
		execute as @e[type=minecraft:armor_stand,tag=Turret2H,tag=!Upgraded1] at @s if entity @e[type=!experience_orb,type=!item,type=!arrow,type=!minecraft:armor_stand,type=!item_frame,type=!painting,tag=!Allowed,distance=..9,tag=!Door] run tag @s add Firing
		execute as @e[type=minecraft:armor_stand,tag=Turret2H,tag=!Upgraded1] at @s unless entity @e[type=!experience_orb,type=!item,type=!arrow,type=!item_frame,type=!minecraft:armor_stand,type=!painting,tag=!Allowed,distance=..9,tag=!Door] run tag @s remove Firing
		execute at @e[type=minecraft:armor_stand,tag=Turret2H,tag=Upgraded1] if entity @e[type=!minecraft:armor_stand,tag=!Allowed,distance=..15,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!Bullet,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ facing entity @e[type=!experience_orb,type=!painting,type=!item_frame,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,tag=!Door,distance=..15,sort=nearest,limit=1]
		execute as @e[type=minecraft:armor_stand,tag=Turret2H,tag=Upgraded1] at @s if entity @e[type=!experience_orb,type=!item,type=!arrow,type=!minecraft:armor_stand,type=!item_frame,type=!painting,tag=!Allowed,distance=..13,tag=!Door] run tag @s add Firing
		execute as @e[type=minecraft:armor_stand,tag=Turret2H,tag=Upgraded1] at @s unless entity @e[type=!experience_orb,type=!item,type=!arrow,type=!item_frame,type=!minecraft:armor_stand,type=!painting,tag=!Allowed,distance=..13,tag=!Door] run tag @s remove Firing
