...
#Searchs for V1 component then adds 1 to TurretCon and tellraws message to player
	...
	#Deletes correct amount of components when constructed
		...
		#Setblock and summons armor stands
			...
			execute at @e[type=minecraft:armor_stand,tag=Turret1,scores={TurretCon=3}] unless entity @e[type=minecraft:armor_stand,tag=BulletAnchor,distance=..1] run summon minecraft:armor_stand ~ ~1.2 ~ {Small:1b,Invisible:1b,NoGravity:1b,Tags:["BulletAnchor","TC"]}
			execute at @e[type=armor_stand,tag=Turret1,scores={TurretCon=3}] run scoreboard players set @e[tag=Turret1H,distance=..1] TC_FireTimer 0
...
#Rotation of V1 and playing ambient sound
	execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=!Upgraded,tag=!Upgraded1] unless entity @e[type=!experience_orb,type=!item_frame,type=!painting,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,distance=..27,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ ~1.5 ~
	execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded] unless entity @e[type=!experience_orb,type=!item_frame,type=!painting,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,distance=..33,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ ~1.5 ~
	execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded1] unless entity @e[type=!experience_orb,type=!item_frame,type=!painting,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,distance=..59,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ ~1.5 ~
	...
	#Detecting for unwanted entities in a radius facing towards them, and adding the "Firing" tag
		execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=!Upgraded] if entity @e[type=!experience_orb,type=!minecraft:armor_stand,tag=!Allowed,distance=..27,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!Bullet,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ facing entity @e[type=!experience_orb,type=!painting,type=!item_frame,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,tag=!Door,distance=..27,sort=nearest,limit=1] 
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=!Upgraded] at @s if entity @e[type=!experience_orb,type=!item,type=!arrow,type=!minecraft:armor_stand,type=!item_frame,type=!painting,tag=!Allowed,distance=..26,tag=!Door] run tag @s add Firing
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=!Upgraded] at @s unless entity @e[type=!experience_orb,type=!item,type=!arrow,type=!item_frame,type=!minecraft:armor_stand,type=!painting,tag=!Allowed,distance=..26,tag=!Door] run tag @s remove Firing
		execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded] if entity @e[type=!experience_orb,type=!minecraft:armor_stand,tag=!Allowed,distance=..33,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!Bullet,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ facing entity @e[type=!experience_orb,type=!painting,type=!item_frame,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,tag=!Door,distance=..33,sort=nearest,limit=1] feet
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded] at @s if entity @e[type=!experience_orb,type=!item,type=!arrow,type=!minecraft:armor_stand,type=!item_frame,type=!painting,tag=!Allowed,distance=..32,tag=!Door] run tag @s add Firing
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded] at @s unless entity @e[type=!experience_orb,type=!item,type=!arrow,type=!item_frame,type=!minecraft:armor_stand,type=!painting,tag=!Allowed,distance=..32,tag=!Door] run tag @s remove Firing
		execute at @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded1] if entity @e[type=!experience_orb,type=!minecraft:armor_stand,tag=!Allowed,distance=..59,tag=!Door] as @e[type=minecraft:armor_stand,distance=..1,tag=!Bullet,tag=!TurretC,tag=TC] at @s run tp @s ~ ~ ~ facing entity @e[type=!experience_orb,type=!painting,type=!item_frame,type=!minecraft:item,type=!minecraft:arrow,type=!minecraft:armor_stand,tag=!Allowed,tag=!Door,distance=..59,sort=nearest,limit=1] feet
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded1] at @s if entity @e[type=!experience_orb,type=!item,type=!arrow,type=!minecraft:armor_stand,type=!item_frame,type=!painting,tag=!Allowed,distance=..58,tag=!Door] run tag @s add Firing
		execute as @e[type=minecraft:armor_stand,tag=Turret1H,tag=Upgraded1] at @s unless entity @e[type=!experience_orb,type=!item,type=!arrow,type=!item_frame,type=!minecraft:armor_stand,type=!painting,tag=!Allowed,distance=..58,tag=!Door] run tag @s remove Firing
