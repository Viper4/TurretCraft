...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=PlayerT,scores={TC_TurretCon=0..1}] if entity @a[nbt=!{ActiveEffects:[{id:14b}]},tag=!Owner,distance=6..20] run tag @s add Firing
...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=PlayerT,scores={TC_TurretCon=2}] if entity @a[nbt=!{ActiveEffects:[{id:14b}]},tag=!Owner,distance=6..26] run tag @s add Firing
...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=FriendlyT,scores={TC_TurretCon=2}] if entity @e[nbt=!{Invisible:1b},nbt=!{ActiveEffects:[{id:14b}]},tag=Friendly,distance=6..26] run tag @s add Firing
...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=NeutralT,scores={TC_TurretCon=0..1}] at @s if entity @e[nbt=!{Invisible:1b},nbt=!{ActiveEffects:[{id:14b}]},tag=Neutral,distance=6..20] run tag @s add Firing
...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=NeutralT,scores={TC_TurretCon=2}] if entity @e[nbt=!{Invisible:1b},nbt=!{ActiveEffects:[{id:14b}]},tag=Neutral,distance=6..26] run tag @s add Firing
...
execute at @s[type=minecraft:armor_stand,tag=Turret3C,tag=!Frame,tag=HostileT,scores={TC_TurretCon=2}] if entity @e[nbt=!{Invisible:1b},nbt=!{ActiveEffects:[{id:14b}]},tag=Hostile,distance=6..26] run tag @s add Firing
