...
execute store result entity @s[tag=!Missile,tag=!Flame] Motion[0] double 0.0001 run scoreboard players get @s TC_PosX
execute store result entity @s[tag=!Missile,tag=!Flame] Motion[1] double 0.0001 run scoreboard players get @s TC_PosY
execute store result entity @s[tag=!Missile,tag=!Flame] Motion[2] double 0.0001 run scoreboard players get @s TC_PosZ
execute store result entity @s[tag=Flame] Motion[0] double 0.00002 run scoreboard players get @s TC_PosX
execute store result entity @s[tag=Flame] Motion[1] double 0.00002 run scoreboard players get @s TC_PosY
execute store result entity @s[tag=Flame] Motion[2] double 0.00002 run scoreboard players get @s TC_PosZ
execute store result entity @s[tag=Missile] Motion[0] double 0.000022 run scoreboard players get @s TC_PosX
execute store result entity @s[tag=Missile] Motion[1] double 0.000022 run scoreboard players get @s TC_PosY
execute store result entity @s[tag=Missile] Motion[2] double 0.000022 run scoreboard players get @s TC_PosZ
tag @s remove New
