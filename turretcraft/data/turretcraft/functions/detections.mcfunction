...
execute at @a[scores={TC_FireTimer=0,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}}] run function turretcraft:deserteagle
...
scoreboard players remove @a[scores={TC_DE_Ammo=0..7,TC_FireTimer=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}}] TC_FireTimer 1
execute at @a[scores={TC_Recoil=1..,TC_FireTimer=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}}] run scoreboard players remove @p TC_Recoil 1
...
clear @a[scores={TC_FireTimer=0,TC_DE_Ammo=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}}] wooden_pickaxe{CustomModelData:2} 1
...
execute at @a[scores={TC_FireTimer=0,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}}] run function turretcraft:ak47
...
scoreboard players remove @a[scores={TC_AK47_Ammo=0..29,TC_FireTimer=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}}] TC_FireTimer 1
execute at @a[scores={TC_Recoil=1..,TC_FireTimer=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}}] run scoreboard players remove @p TC_Recoil 1
...
execute at @a[tag=!Admin,nbt={Inventory:[{id:"minecraft:wooden_pickaxe",tag:{CustomModelData:1}}]},scores={TC_FireTimer=0,TC_AK47_Ammo=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1.1
...
execute at @a[scores={TC_FireTimer=0,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}}] run function turretcraft:m16
execute at @a[tag=!Admin,scores={TC_M16_Ammo=0..29,TC_FireTimer=..0},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}},{id:"minecraft:wooden_pickaxe",tag:{CustomModelData:4}}]}] run scoreboard players set @p TC_FireTimer 50
...
scoreboard players remove @a[scores={TC_M16_Ammo=0..29,TC_FireTimer=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}}] TC_FireTimer 1
execute at @a[scores={TC_M16_Ammo=0..30,TC_Recoil=1..,TC_FireTimer=..0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}}] run scoreboard players remove @p TC_Recoil 1
...
execute at @a[tag=!Admin,nbt={Inventory:[{id:"minecraft:wooden_pickaxe",tag:{CustomModelData:4}}]},scores={TC_FireTimer=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1
...
execute at @a[scores={TC_FireTimer=0,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}}] run function turretcraft:awp
...
scoreboard players remove @a[scores={TC_AWP_Ammo=0..9,TC_FireTimer=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}}] TC_FireTimer 1
