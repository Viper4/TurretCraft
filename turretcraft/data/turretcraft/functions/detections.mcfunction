...
execute as @e[type=armor_stand,tag=Turret3C] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:5}}},distance=..1,limit=1] store result score @s TC_M16_Ammo run data get entity @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:5}}},distance=..1,limit=1] Item.Count 4
execute as @e[type=armor_stand,tag=Turret4C] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:6}}},distance=..1,limit=1] store result score @s TC_M16_Ammo run data get entity @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:6}}},distance=..1,limit=1] Item.Count 50
execute as @e[type=armor_stand,tag=TurretC] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:clock"}},distance=..1,limit=1] run scoreboard players operation @s TC_AK47_Ammo += @s TC_M16_Ammo
execute as @e[type=armor_stand,tag=TurretC] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:clock"}},distance=..1,limit=1] run scoreboard players set @s TC_M16_Ammo 0
...
execute as @e[type=armor_stand,tag=TurretC,tag=!Turret3C,tag=!Turret4C] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:1}}},distance=..1,limit=1]
execute as @e[type=armor_stand,tag=Turret3C] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:5}}},distance=..1,limit=1]
execute as @e[type=armor_stand,tag=Turret4C] at @s run kill @e[type=item,nbt={Item:{id:"minecraft:clock",tag:{CustomModelData:6}}},distance=..1,limit=1]
...
execute at @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:2}}]},scores={TC_FireTimer=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1
tellraw @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:2}}]},scores={TC_FireTimer=39}] {"text":"Reloading...","color":"gray"}
...
clear @a[tag=!Admin,scores={TC_FireTimer=50,TC_AK47_Ammo=0..29},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}]}] clock{CustomModelData:1} 1
...
execute at @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:1}}]},scores={TC_FireTimer=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1.1
tellraw @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:1}}]},scores={TC_FireTimer=49}] {"text":"Reloading...","color":"gray"}
...
clear @a[tag=!Admin,scores={TC_FireTimer=50,TC_M16_Ammo=0..29},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}]}] clock{CustomModelData:4} 1
...
execute at @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:4}}]},scores={TC_FireTimer=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1
tellraw @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:4}}]},scores={TC_FireTimer=49}] {"text":"Reloading...","color":"gray"}
...
execute at @a[tag=!Admin,scores={TC_AWP_Ammo=0..9,TC_FireTimer=..0},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}]},nbt=!{Inventory:[{id:"minecraft:clock",tag:{CustomModelData:3}}]}] run tellraw @p {"text":"No Ammo left","color":"red"}
clear @a[tag=!Admin,scores={TC_FireTimer=70,TC_AWP_Ammo=0..9},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}]}] clock{CustomModelData:3} 1
...
execute at @a[scores={TC_AWP_Ammo=0..9,TC_FireTimer=0},nbt={Inventory:[{id:"minecraft:clock",tag:{CustomModelData:3}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}}] run scoreboard players set @p TC_AWP_Ammo 10
execute at @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:3}}]},scores={TC_FireTimer=0}] run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1 1
tellraw @a[tag=!Admin,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}},Inventory:[{id:"minecraft:clock",tag:{CustomModelData:3}}]},scores={TC_FireTimer=69}] {"text":"Reloading...","color":"gray"}
