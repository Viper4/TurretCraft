...
execute at @p[scores={TC_DE_Ammo=1..8},distance=..1] positioned ~ ~1.6 ~ run summon arrow ^ ^ ^0.1 {CustomName:'{"text":"Desert Eagle"}',Tags:["Bullet","New","Player"],damage:1.2,SoundEvent:"minecraft:block.stone.break"}
