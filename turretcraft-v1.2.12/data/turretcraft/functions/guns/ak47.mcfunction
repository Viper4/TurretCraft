...
execute at @p[distance=..1,scores={TC_AK47_Ammo=1..30,TC_Shifting=0}] positioned ~ ~1.6 ~ run summon arrow ^ ^ ^1.1 {CustomName:'{"text":"AK47"}',Tags:["Bullet","New","Player","AK47"],damage:0.8,SoundEvent:"minecraft:block.stone.break",Owner:[I;0, 0, 0, 0]}
execute at @p[distance=..1,scores={TC_AK47_Ammo=1..30,TC_Shifting=1..}] positioned ~ ~1.6 ~ run summon arrow ^ ^ ^1.1 {CustomName:'{"text":"AK47"}',Tags:["Bullet","New","Player","AK47","Shift"],damage:0.8,SoundEvent:"minecraft:block.stone.break",Owner:[I;0, 0, 0, 0]}
execute at @p[distance=..1,scores={TC_AK47_Ammo=1..30}] positioned ~ ~1.6 ~ run summon armor_stand ^ ^ ^1 {Tags:["BulletAnchor","Player"],Invisible:1b,Small:1b,NoGravity:1b}
