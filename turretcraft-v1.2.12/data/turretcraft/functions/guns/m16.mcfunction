...
execute at @p[scores={TC_M16_Ammo=1..30,TC_Shifting=0},distance=..1] positioned ~ ~1.6 ~ run summon arrow ^ ^ ^1.1 {CustomName:'{"text":"M16"}',Tags:["Bullet","New","Player","M16"],PierceLevel:1,damage:0.5,SoundEvent:"minecraft:block.stone.break",Owner:[I;0, 0, 0, 0],ShotFromCrossbow:1b}
execute at @p[scores={TC_M16_Ammo=1..30,TC_Shifting=1..},distance=..1] positioned ~ ~1.6 ~ run summon arrow ^ ^ ^1.1 {CustomName:'{"text":"M16"}',Tags:["Bullet","New","Player","M16","Shift"],PierceLevel:1,damage:0.5,SoundEvent:"minecraft:block.stone.break",Owner:[I;0, 0, 0, 0],ShotFromCrossbow:1b}
execute at @p[scores={TC_M16_Ammo=1..30},distance=..1] positioned ~ ~1.6 ~ run summon armor_stand ^ ^ ^1 {Tags:["BulletAnchor","Player"],Invisible:1b,Small:1b,NoGravity:1b}
