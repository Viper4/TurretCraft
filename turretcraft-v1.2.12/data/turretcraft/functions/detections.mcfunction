...
execute at @a[scores={TC_Turret=-1},tag=Owner] as @e[type=armor_stand,tag=TurretC,distance=..3,limit=1,sort=nearest] run function turretcraft:turrets/turret_deletion
execute as @e[type=armor_stand,tag=TurretC,tag=!Frame] at @s unless entity @e[type=wither_skeleton,tag=TurretHealth,distance=..1] run function turretcraft:turrets/turret_deletion
...
execute at @a[tag=TC_RemoteControl] run function turretcraft:remote_control/remote_control
execute at @a[tag=Owner,tag=!TC_RemoteControl,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:5}}},scores={TC_RightClick=1..,TC_Shifting=1..}] as @e[type=armor_stand,tag=TC,tag=TurretC,limit=1,sort=nearest,distance=..3] run function turretcraft:remote_control/remote_control_pair
execute at @a[tag=TC_RemoteControl,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:5}}},scores={TC_RightClick=1..,TC_Shifting=1..},limit=1,sort=nearest] as @e[type=armor_stand,tag=TC,tag=TurretC,tag=!TC_RemoteControl] if score @s TC_Frequency = @p TC_Frequency run tag @s add TC_RemoteControlSwitch
execute at @a[tag=TC_RemoteControl,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:5}}},scores={TC_RightClick=1..,TC_Shifting=1..},limit=1,sort=nearest] as @e[type=armor_stand,tag=TC,tag=TurretC,tag=!TC_RemoteControl,tag=TC_RemoteControlSwitch,limit=1,sort=random] run function turretcraft:remote_control/remote_control_switch
tag @e[tag=TurretC,tag=TC_RemoteControlSwitch] remove TC_RemoteControlSwitch
execute at @a[tag=TC_RemoteControlStart,limit=1,sort=nearest] as @e[type=armor_stand,tag=TC,tag=TurretC,tag=!TC_RemoteControl] if score @s TC_Frequency = @p TC_Frequency run tag @s add TC_RemoteControlStart
execute at @a[tag=TC_RemoteControlStart,limit=1,sort=nearest] as @e[type=armor_stand,tag=TC,tag=TurretC,tag=!TC_RemoteControl,tag=TC_RemoteControlStart,limit=1,sort=nearest] run function turretcraft:remote_control/remote_control_start
tag @e[tag=TurretC,tag=TC_RemoteControlStart] remove TC_RemoteControlStart
execute at @a[tag=TC_RemoteControlStop] as @e[tag=RemoteControlHome,tag=!New] if score @s TC_UUID0 = @p TC_UUID0 if score @s TC_UUID1 = @p TC_UUID1 if score @s TC_UUID2 = @p TC_UUID2 run function turretcraft:remote_control/remote_control_stop
execute at @a[tag=TC_RemoteControlStart] run tellraw @p [{"text":"[Turretcraft]","color":"dark_green"},{"text":" No turret found on the frequency: ","color":"gray"},{"score":{"name":"@p","objective":"TC_Frequency"},"color":"dark_gray"},{"text":".","color":"gray"}]
tag @a[tag=TC_RemoteControlStart] remove TC_RemoteControlStart

#Turret firing
scoreboard players remove @e[type=armor_stand,tag=TurretC,scores={TC_FireTimer=1..}] TC_FireTimer 1
execute as @e[type=armor_stand,tag=TurretC,tag=Firing,scores={TC_FireTimer=0,TC_AK47_Ammo=1..}] run function turretcraft:turrets/firing
...
scoreboard players add @e[type=arrow,tag=Bullet] TC_FireTimer 1
...
execute as @e[type=arrow,tag=Bullet,tag=Missile,scores={TC_FireTimer=..5}] store result entity @s Motion[0] double 0.00022 run scoreboard players get @s TC_PosX
execute as @e[type=arrow,tag=Bullet,tag=Missile,scores={TC_FireTimer=..5}] store result entity @s Motion[1] double 0.00022 run scoreboard players get @s TC_PosY
execute as @e[type=arrow,tag=Bullet,tag=Missile,scores={TC_FireTimer=..5}] store result entity @s Motion[2] double 0.00022 run scoreboard players get @s TC_PosZ
...
execute as @e[type=armor_stand,tag=TurretC,tag=!off] at @s if entity @e[type=item,distance=..1,limit=1] run function turretcraft:turrets/upgrades
...
execute at @a[scores={TC_FireTimer=-1,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}}] run function turretcraft:guns/deserteagle
...
execute at @a[scores={TC_FireTimer=-1,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:1}}}] run function turretcraft:guns/ak47
...
execute at @a[scores={TC_FireTimer=-1,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:4}}}] run function turretcraft:guns/m16
...
execute at @a[scores={TC_FireTimer=-1,TC_RightClick=1,TC_Recoil=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}}] run function turretcraft:guns/awp
